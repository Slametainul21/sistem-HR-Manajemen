            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="role_id" class="form-control @error('role_id') is-invalid @enderror" name="role_id" required>
                                    ...
                                    <option value="0" {{ old('role_id') == '0' ? 'selected' : '' }}>HR</option>
                        ...
                        <div class="row mb-3" id="department-section">
                            <label for="department_id" class="col-md-4 col-form-label text-md-end">{{ __('Division') }}</label>
                            <div class="col-md-6">
...
$(document).ready(function() {
    ...
    $('#role_id').change(toggleDepartmentSection);
